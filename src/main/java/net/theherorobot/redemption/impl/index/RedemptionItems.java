...
import net.theherorobot.redemption.impl.item.CourtGlassItem;
import net.theherorobot.redemption.impl.item.HuntersCourtGlassItem;
import net.theherorobot.redemption.impl.item.KatanaItem;
import net.theherorobot.redemption.impl.util.KatanaType;
import net.theherorobot.redemption.impl.util.RedemptionItemSettings;
